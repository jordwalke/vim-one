...
function! airline#themes#one#refresh()
  ...
  let s:N1 = airline#themes#get_highlight2(['Normal', 'bg'], ['DiffAdd', 'bg'], 'none')
  ...
  let g:airline#themes#one#palette.insert_modified = g:airline#themes#one#palette.insert
  ...
  let g:airline#themes#one#palette.replace_modified = g:airline#themes#one#palette.replace
  ...
  let g:airline#themes#one#palette.visual_modified = g:airline#themes#one#palette.visual
